...
\begin{enumerate}[\thechapter.\thesection .1]
\item \label{Image is subspace} In the opening of the chapter, we use Theorem \ref{VectorDecomposition}, but we can only do this if $\mathcal P$ is a subspace, meaning that it's closed under vector addition and scalar multiplication.  Prove that any matrix's image is a subspace.
